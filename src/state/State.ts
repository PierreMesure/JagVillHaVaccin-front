...
export type TypePlateforme = "MittVaccin"|"Vaccina"|"1177"; //|"Doctolib"|"Maiia"|"Ordoclic"|"Keldoc"|"Pandalab"|"Mapharma"|"AvecMonDoc";
...
export const PLATEFORMES: Record<TypePlateforme, Plateforme> = {
    ...
    '1177': { code: '1177', logo: 'logo_1177.png', nom: '1177', promoted: false,  website: 'https://1177.se/',  styleCode: '_doctolib'}
};
/*
{
